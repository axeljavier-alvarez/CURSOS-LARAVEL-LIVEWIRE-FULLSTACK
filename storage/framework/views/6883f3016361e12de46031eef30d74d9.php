            ...
            x-init="
                new Sortable($refs.sections, {
                    ...
                    onEnd: () => {
                        ...
                        window.Livewire.find('<?php echo e($_instance->getId()); ?>').call('sortSections', sortedIds);
                    }
                });
            "
        >
            ...
            <li data-id="<?php echo e($section->id); ?>" wire:key="section-<?php echo e($section->id); ?>">
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes([]); ?>Actualizar <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                ...
                <div x-data="{ open: false }" x-on:close-section-position-create.window="open = false">
                    ...
                    <div x-show="open" x-cloak class="mt-4 ml-10">
                        <form wire:submit.prevent="storePosition(<?php echo e($section->id); ?>)">
...
<?php endif; ?>
                                ...
                                <?php if (isset($component)) { $__componentOriginalc2fcfa88dc54fee60e0757a7e0572df1 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalc2fcfa88dc54fee60e0757a7e0572df1 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input','data' => ['wire:model' => 'sectionPositionCreate.'.e($section->id).'.name','class' => 'w-full','placeholder' => 'Ingrese el nombre de la nueva sección']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:model' => 'sectionPositionCreate.'.e($section->id).'.name','class' => 'w-full','placeholder' => 'Ingrese el nombre de la nueva sección']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalc2fcfa88dc54fee60e0757a7e0572df1)): ?>
<?php $attributes = $__attributesOriginalc2fcfa88dc54fee60e0757a7e0572df1; ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['@click' => 'open = false']); ?>
                                        Cancelar
                                     <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal656e8c5ea4d9a4fa173298297bfe3f11)): ?>
